 ...
 */
export const scheduleGuest = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/schedule-guest'
 */
scheduleGuest.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: scheduleGuest.url(options),
    method: 'head',
})
 ...
 * @route '/schedule-guest'
 */
    const scheduleGuestForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/schedule-guest'
 */
        scheduleGuestForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: scheduleGuest.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/schedule-guest'
 */
        scheduleGuestForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
