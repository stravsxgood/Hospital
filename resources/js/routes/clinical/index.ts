 ...
 * @route '/api/clinical/icd10'
 */
    const icd10Form = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 */
export const safetyCheck = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/api/clinical/safety-check'
 */
    const safetyCheckForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/clinical/safety-check'
 */
        safetyCheckForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: safetyCheck.url(options),
            method: 'post',
        })
 ...
 */
export const checkSafety = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/api/clinical/check-safety'
 */
    const checkSafetyForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/clinical/check-safety'
 */
        checkSafetyForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: checkSafety.url(options),
            method: 'post',
        })
