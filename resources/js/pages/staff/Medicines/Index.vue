...
const submitMedicineForm = () => {
    if (isEditing.value && selectedMedicine.value) {
        medicineForm.put(
            `/staff/medicines/${selectedMedicine.value.medicine_id}`,
            {
...
const submitStockAdjustment = () => {
    ...
    stockForm.post(
        `/staff/medicines/${adjustingMedicine.value.medicine_id}/adjust-stock`,
        {
...
<template>
    ...
    >
        <div class="mx-auto max-w-7xl space-y-6">
            ...
            >
                <div class="space-y-1">
                    <div
                        class="flex items-center gap-2 text-xs font-semibold tracking-wider text-[#333333]/70 uppercase"
                    >
                        <Link
                            href="/staff"
                    ...
                    <p class="text-xs text-[#333333]/80 sm:text-sm">
                        Monitoring stok fisik real-time, pengadaan restok obat,
                        dan pemutakhiran tarif farmasi rumah sakit.
                    </p>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <motion.button
                        ...
                        class="inline-flex min-h-[44px] items-center justify-center gap-2 rounded-[40.5px] bg-[#000000] px-5 py-2.5 text-sm font-semibold text-[#ffffff] shadow-sm transition-all hover:bg-[#333333]"
                    >
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    <div class="flex items-center justify-between">
                        <span
                            class="text-xs font-semibold tracking-wider text-[#333333]/70 uppercase"
                            >Total Katalog</span
                        >
                        <div
                            class="flex size-9 items-center justify-center rounded-full bg-[#beedc0]/40 text-[#065f46]"
                        >
                            <Pill class="size-4" />
                        </div>
                    </div>
                    ...
                    <div class="mt-2 text-xs text-[#333333]/70">
                        ...
                        <strong class="text-[#000000]">{{
                            stats.total_stock_units.toLocaleString('id-ID')
                        }}</strong>
                        unit
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div class="mt-3 flex items-baseline gap-2">
                        <span
                            class="font-['ivypresto-headline'] text-2xl font-bold"
                            :class="
                                stats.out_of_stock_count > 0
                                    ? 'text-rose-700'
                                    : 'text-[#000000]'
                    ...
                    >
                        {{
                            stats.out_of_stock_count > 0
                                ? 'Perlu tindakan restok segera'
                                : 'Semua obat memiliki stok'
                        }}
                    </div>
                </motion.div>
                ...
                >
                    ...
                    >
                        {{
                            stats.low_stock_count > 0
                                ? 'Disarankan membuat PO restok'
                                : 'Persediaan dalam batas aman'
                        }}
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div class="mt-3 flex items-baseline gap-2">
                        <span
                            class="font-['ivypresto-headline'] text-xl font-bold text-[#065f46] sm:text-2xl"
                        >
                ...
                >
                    ...
                    <div class="relative flex-1">
                        ...
                        <input
                            ...
                            class="min-h-[44px] w-full rounded-[40.5px] border border-[#333333]/20 bg-[#edede2]/60 pr-4 pl-10 text-sm text-[#000000] placeholder:text-[#333333]/40 focus:border-[#000000] focus:bg-[#ffffff] focus:ring-1 focus:ring-[#000000] focus:outline-none"
                        />
                        <button
                            v-if="searchQuery"
                            type="button"
                            ...
                            <button
                                ...
                                :class="
                                    selectedStockStatus === 'out'
                                        ? 'bg-rose-600 text-[#ffffff] shadow-sm'
                                        : 'text-[#333333] hover:text-rose-700'
                                "
                            >
                                Habis (0)
                            </button>
            ...
            >
                            ...
                            >
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div
                                                class="font-bold text-[#000000]"
                                            >
                                                {{ med.name_medicine }}
                                            </div>
                                            <div
                                                class="font-mono text-xs font-medium text-[#333333]/70"
                                            >
                                                {{ med.code_medicine }}
                                            </div>
                                        </div>
                                ...
                                <td class="px-4 py-4">
                                    <span
                                        class="inline-flex items-center rounded-full bg-[#edede2] px-2.5 py-1 text-xs font-medium text-[#000000]"
                                    >
                                        {{ med.type }}
                                    </span>
                                </td>
                                ...
                                <!-- Satuan -->
                                <td
                                    class="px-4 py-4 text-xs font-medium text-[#333333]"
                                >
                                    {{ med.unit }}
                                </td>
                                ...
                                <!-- Harga Satuan -->
                                <td
                                    class="px-4 py-4 text-right font-medium text-[#000000]"
                                >
                                ...
                                <!-- Nilai Stok -->
                                <td
                                    class="px-4 py-4 text-right font-semibold text-[#065f46]"
                                >
                                    {{
                                        formatRupiah(
                                            Number(med.price) *
                                ...
                                <td class="px-5 py-4 text-center">
                                    ...
                                    >
                                        ...
                                        <motion.button
                                            ...
                                            class="inline-flex min-h-[36px] items-center gap-1 rounded-[40.5px] border border-[#065f46]/30 bg-[#beedc0]/40 px-3 py-1.5 text-xs font-semibold text-[#065f46] transition-all hover:bg-[#beedc0]"
                                        >
                                        ...
                                        <motion.button
                                            ...
                                            class="inline-flex size-9 min-h-[36px] items-center justify-center rounded-full border border-[#333333]/15 bg-[#ffffff] text-[#333333] transition-all hover:bg-[#edede2] hover:text-[#000000]"
                                        >
                                        ...
                                        <motion.button
                                            ...
                                            title="Hapus Obat"
                                            class="inline-flex size-9 min-h-[36px] items-center justify-center rounded-full border border-rose-200 bg-rose-50 text-rose-600 transition-all hover:bg-rose-100"
                                        >
                            ...
                            <tr v-if="medicines.data.length === 0">
                                ...
                                >
                                    ...
                                    <div class="mt-2 font-medium">
                                        Tidak ada data obat yang sesuai dengan
                                        pencarian.
                                    </div>
                                    <button
                                        v-if="
                ...
                >
                    <div class="text-xs text-[#333333]/70">
                        Menampilkan
                        <strong>{{ medicines.data.length }}</strong> dari
                        <strong>{{ medicines.total }}</strong> obat
                    </div>
                    <div class="flex items-center gap-1.5">
                        <template v-for="(link, i) in medicines.links" :key="i">
                            <Link
                                ...
                                :class="
                                    link.active
                                        ? 'bg-[#000000] font-bold text-[#ffffff] shadow-sm'
        ...
        >
            ...
            >
                <div class="flex items-center gap-2.5">
                    <div
                        class="flex size-9 items-center justify-center rounded-full bg-[#beedc0] text-[#065f46]"
                    >
                        <Pill class="size-4" />
                    </div>
                    <div>
                        ...
                        >
                            {{
                                isEditing
                                    ? 'Edit Data Obat Farmasi'
                                    : 'Tambah Obat Baru ke Katalog'
                            }}
                        </h3>
                        <p class="text-xs text-[#333333]/70">
                            {{
                                isEditing
                                    ? 'Perbarui informasi dan harga obat'
                                    : 'Masukkan rincian spesifikasi obat farmasi'
                            }}
                        </p>
                    </div>
                </div>
            ...
            <form
                @submit.prevent="submitMedicineForm"
                class="mt-5 space-y-4 font-['Rubik'] text-sm"
            >
                <!-- Kode Obat -->
                <div>
                    <label
                        class="block text-xs font-semibold tracking-wider text-[#333333]/80 uppercase"
                    >
                    ...
                    <input
                        ...
                        class="mt-1 min-h-[44px] w-full rounded-[40.5px] border border-[#333333]/20 bg-[#edede2]/60 px-4 font-mono text-sm text-[#000000] uppercase focus:border-[#000000] focus:bg-[#ffffff] focus:ring-1 focus:ring-[#000000] focus:outline-none"
                        required
                    />
                    <p
                        v-if="medicineForm.errors.code_medicine"
                ...
                <div>
                    ...
                    <input
                        ...
                        class="mt-1 min-h-[44px] w-full rounded-[40.5px] border border-[#333333]/20 bg-[#edede2]/60 px-4 text-sm text-[#000000] focus:border-[#000000] focus:bg-[#ffffff] focus:ring-1 focus:ring-[#000000] focus:outline-none"
                        required
                    />
                    <p
                        v-if="medicineForm.errors.name_medicine"
                        class="mt-1 text-xs font-medium text-rose-600"
                    >
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <select
                            ...
                            class="mt-1 min-h-[44px] w-full appearance-none rounded-[40.5px] border border-[#333333]/20 bg-[#edede2]/60 px-4 text-sm text-[#000000] focus:border-[#000000] focus:bg-[#ffffff] focus:ring-1 focus:ring-[#000000] focus:outline-none"
                            required
                        >
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        >
                            {{
                                isEditing ? 'Stok Fisik Saat Ini' : 'Stok Awal'
                            }}
                            <span class="text-rose-500">*</span>
                        </label>
                        <input
                        ...
                        />
                        <p
                            v-if="medicineForm.errors.stock"
                            class="mt-1 text-xs font-medium text-rose-600"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="0"
                            step="500"
                            class="mt-1 min-h-[44px] w-full rounded-[40.5px] border border-[#333333]/20 bg-[#edede2]/60 px-4 text-sm font-semibold text-[#065f46] focus:border-[#000000] focus:bg-[#ffffff] focus:ring-1 focus:ring-[#000000] focus:outline-none"
                            required
                        />
                        <p
                            v-if="medicineForm.errors.price"
                            class="mt-1 text-xs font-medium text-rose-600"
                        >
                ...
                <!-- Tombol Submit & Batal -->
                <div
                    class="flex items-center justify-end gap-3 border-t border-[#333333]/10 pt-4"
                >
                    <button
                        type="button"
                        @click="closeFormModal"
    ...
    >
        ...
        >
            ...
            >
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        ...
                        <p class="font-mono text-xs text-[#333333]/70">
            ...
            <div
                class="mt-4 rounded-[10px] bg-[#edede2]/60 p-3.5 text-xs text-[#333333]"
            >
                <div class="text-sm font-bold text-[#000000]">
                    {{ adjustingMedicine.name_medicine }}
                </div>
                <div class="mt-1 flex items-center justify-between">
                    <span
                        >Sediaan: {{ adjustingMedicine.type }} ({{
                            adjustingMedicine.unit
                        }})</span
                    >
                    <span
                        >Stok Saat Ini:
                        <strong class="text-sm font-bold text-[#000000]">{{
                            adjustingMedicine.stock
                        }}</strong></span
                    >
                </div>
            </div>
            ...
            <form
                ...
                class="mt-4 space-y-4 font-['Rubik'] text-sm"
            >
                ...
                <div>
                    ...
                    <div class="mt-1.5 grid grid-cols-3 gap-2">
                        <button
                            ...
                            class="flex min-h-[44px] flex-col items-center justify-center rounded-[10px] border p-2 text-xs font-semibold transition-all"
                            :class="
                                stockForm.type === 'add'
                                    ? 'border-[#065f46] bg-[#beedc0]/50 text-[#065f46]'
                                    : 'border-[#333333]/15 bg-[#ffffff] text-[#333333] hover:bg-[#edede2]'
                            "
                        >
                            <PackagePlus class="mb-0.5 size-4" />
                            <span>Tambah (+)</span>
                        </button>
                        <button
                            type="button"
                            ...
                            "
                        >
                            <PackageMinus class="mb-0.5 size-4" />
                            <span>Kurangi (-)</span>
                        </button>
                        <button
                            type="button"
                ...
                <div>
                    <label
                        class="block text-xs font-semibold tracking-wider text-[#333333]/80 uppercase"
                    >
                        Jumlah Unit ({{ adjustingMedicine.unit }})
                        <span class="text-rose-500">*</span>
                    </label>
                    <input
                        ...
                        type="number"
                        min="1"
                        class="mt-1 min-h-[44px] w-full rounded-[40.5px] border border-[#333333]/20 bg-[#edede2]/60 px-4 text-base font-bold text-[#000000] focus:border-[#000000] focus:bg-[#ffffff] focus:ring-1 focus:ring-[#000000] focus:outline-none"
                        required
                    />
                    <p
                        v-if="stockForm.errors.amount"
                        class="mt-1 text-xs font-medium text-rose-600"
                    >
                ...
                <div>
                    ...
                    <input
                        ...
                        class="mt-1 min-h-[44px] w-full rounded-[40.5px] border border-[#333333]/20 bg-[#edede2]/60 px-4 text-xs text-[#000000] focus:border-[#000000] focus:bg-[#ffffff] focus:ring-1 focus:ring-[#000000] focus:outline-none"
                    />
                </div>

                <!-- Live Preview Hasil Akhir -->
                <div
                    class="flex items-center justify-between rounded-[10px] border border-[#beedc0] bg-[#beedc0]/30 p-3 text-xs"
                >
                    <span class="font-medium text-[#065f46]"
                        >Estimasi Stok Setelah Penyesuaian:</span
                    >
                ...
                <!-- Tombol Submit & Batal -->
                <div
                    class="flex items-center justify-end gap-3 border-t border-[#333333]/10 pt-3"
                >
                    <button
                        type="button"
                        @click="closeStockModal"
    ...
    >
        ...
        >
            ...
            >
                <div class="flex items-center gap-3">
                    <div
                        class="flex size-10 items-center justify-center rounded-full bg-rose-100 text-rose-700"
                    >
                        <Trash2 class="size-5" />
                    </div>
                    <div>
            ...
            >
                ...
                >
                    <div>
                        ...
                        <div class="font-semibold text-[#000000]">
                            {{ deletingMedicine.type }} ({{
                                deletingMedicine.unit
                            }})
                        </div>
                    </div>
                    <div>
                ...
                <div
                    ...
                    class="space-y-1 rounded-[8px] border border-amber-300 bg-amber-50 p-2.5 text-[11px] text-amber-900"
                >
                    <div class="flex items-center gap-1.5 font-bold">
                        <AlertTriangle class="size-3.5 text-amber-700" />
                        <span
                            >Peringatan Stok Aktif: {{ deletingMedicine.stock }}
                            {{ deletingMedicine.unit }}</span
                        >
                    </div>
                    <p class="text-[10px] leading-relaxed text-amber-800">
                        Obat ini masih memiliki stok fisik tercatat di gudang
                        farmasi. Menghapus data ini akan menghilangkannya dari
                        master inventori.
                    </p>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end gap-3 pt-2">
                ...
                >
                    ...
                    <span>{{
                        isDeleting ? 'Menghapus...' : 'Hapus Obat Permanen'
                    }}</span>
                </button>
            </div>
        </motion.div>
