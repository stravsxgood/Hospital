        ...
        riveInstance = new RiveConstructor({
            ...
            onLoad: () => {
                ...
                if (inputs) {
                    ...
                    inputRemember =
                        inputs.find((i) => i.name === 'rememberMe') || null;
                    inputError =
                        inputs.find((i) => i.name === 'hasError') || null;
            ...
            onLoadError: (err) => {
                ...
                console.error(
                    'File /assets/rive/hospital.riv gagal dimuat:',
                    err,
                );
            },
        });
...
<template>
    ...
    >
        <motion.div
            ...
            class="grid w-full max-w-6xl grid-cols-1 overflow-hidden rounded-[10px] border border-neutral-200 bg-[#fffff3] lg:grid-cols-12"
        >
            ...
            >
                ...
                <div class="z-10 my-8 space-y-6 py-6 lg:my-auto">
                    <div class="space-y-3">
                        ...
                        >
                            Satu akun untuk kemudahan antrean poli, jadwal
                            dokter spesialis, hingga rekam medis keluarga Anda.
                        </p>
                    </div>
                ...
                <div class="mx-auto w-full max-w-md space-y-6">
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-[#333333] sm:text-base">
                            Silakan masukkan email dan kata sandi Anda yang
                            telah terdaftar.
                        </p>
                    </div>
                    ...
                    <div
                        v-if="status"
                        class="rounded-[7px] border border-neutral-300 bg-[#beedc0] p-4 text-center text-sm font-medium text-[#000000] shadow-sm"
                    >
                        {{ status }}
                    </div>
                    ...
                    <form @submit.prevent="submit" class="flex flex-col gap-5">
                        ...
                        <div class="grid gap-2">
                            <div class="flex items-center justify-between">
                                ...
                                <TextLink
                                    ...
                                    class="text-xs font-medium text-[#333333] underline underline-offset-2 transition-colors hover:text-[#000000] sm:text-sm"
                                >
                                    Lupa kata sandi?
                                </TextLink>
                            </div>
                        ...
                        <div class="flex items-center justify-between py-1">
                            <Label
                                for="remember"
                                class="flex min-h-[44px] cursor-pointer items-center space-x-3 text-sm font-medium text-[#333333] select-none"
                            >
                                <Checkbox
                                    id="remember"
                                    :checked="form.remember"
                                    @update:checked="form.remember = $event"
                                    class="h-5 w-5 rounded border-neutral-300 text-[#000000] focus:ring-[#000000]"
                                />
