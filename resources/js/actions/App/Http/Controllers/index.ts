...
const Controllers = {
    ...
    XenditWebhookController: Object.assign(
    ...
    PublicDisplayController: Object.assign(
        PublicDisplayController,
        PublicDisplayController,
    ),
    DoctorSchedulePageController: Object.assign(
        DoctorSchedulePageController,
        DoctorSchedulePageController,
    ),
    PatientStoryController: Object.assign(
        PatientStoryController,
        PatientStoryController,
    ),
    SpecializationController: Object.assign(
        SpecializationController,
        SpecializationController,
    ),
    PoliTeamController: Object.assign(PoliTeamController, PoliTeamController),
    ClinicLocationController: Object.assign(
        ClinicLocationController,
        ClinicLocationController,
    ),
    ProfileController: Object.assign(ProfileController, ProfileController),
    PatientDashboardController: Object.assign(
        PatientDashboardController,
        PatientDashboardController,
    ),
    AppointmentController: Object.assign(
        AppointmentController,
        AppointmentController,
    ),
    Teams: Object.assign(Teams, Teams),
    StaffDashboardController: Object.assign(
        StaffDashboardController,
        StaffDashboardController,
    ),
    StaffActionController: Object.assign(
        StaffActionController,
        StaffActionController,
    ),
    MedicalDocumentController: Object.assign(
    ...
    CashierShiftController: Object.assign(
        CashierShiftController,
        CashierShiftController,
    ),
    AuditLogController: Object.assign(AuditLogController, AuditLogController),
    DoctorQueueController: Object.assign(
        DoctorQueueController,
        DoctorQueueController,
    ),
    DoctorSupervisionController: Object.assign(
        DoctorSupervisionController,
        DoctorSupervisionController,
    ),
    KoasLogbookController: Object.assign(
        KoasLogbookController,
        KoasLogbookController,
    ),
    ClinicalAssistantController: Object.assign(
        ClinicalAssistantController,
        ClinicalAssistantController,
    ),
    SatuSehatController: Object.assign(
        SatuSehatController,
        SatuSehatController,
    ),
