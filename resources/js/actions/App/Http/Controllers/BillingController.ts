 ...
 */
export const generateQris = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/staff/billing/{id}/pay-qris'
 */
generateQris.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
    ...
    return generateQris.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/staff/billing/{id}/pay-qris'
 */
generateQris.post = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: generateQris.url(args, options),
    method: 'post',
})
 ...
 * @route '/staff/billing/{id}/pay-qris'
 */
    const generateQrisForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/staff/billing/{id}/pay-qris'
 */
        generateQrisForm.post = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: generateQris.url(args, options),
            method: 'post',
        })
 ...
 */
export const checkStatus = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/staff/billing/{id}/status'
 */
checkStatus.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
 ...
 * @route '/staff/billing/{id}/status'
 */
checkStatus.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: checkStatus.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/staff/billing/{id}/status'
 */
checkStatus.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: checkStatus.url(args, options),
    method: 'head',
})
 ...
 * @route '/staff/billing/{id}/status'
 */
    const checkStatusForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/staff/billing/{id}/status'
 */
        checkStatusForm.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: checkStatus.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/staff/billing/{id}/status'
 */
        checkStatusForm.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 */
export const printThermalReceipt = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/staff/billing/{id}/print-thermal'
 */
printThermalReceipt.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
    ...
    return printThermalReceipt.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/staff/billing/{id}/print-thermal'
 */
printThermalReceipt.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: printThermalReceipt.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/staff/billing/{id}/print-thermal'
 */
printThermalReceipt.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: printThermalReceipt.url(args, options),
    method: 'head',
})
 ...
 * @route '/staff/billing/{id}/print-thermal'
 */
    const printThermalReceiptForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/staff/billing/{id}/print-thermal'
 */
        printThermalReceiptForm.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: printThermalReceipt.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/staff/billing/{id}/print-thermal'
 */
        printThermalReceiptForm.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
const BillingController = { index, show, createFromReservation, payCash, generateQris, payEdc, payXendit, checkStatus, printThermalReceipt }
