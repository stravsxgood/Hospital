 ...
 */
export const liveData = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/display/live-data'
 */
    const liveDataForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/display/live-data'
 */
        liveDataForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: liveData.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/display/live-data'
 */
        liveDataForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: liveData.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
