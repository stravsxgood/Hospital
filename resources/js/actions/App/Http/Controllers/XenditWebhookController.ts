 ...
 */
export const handleQrCallback = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/api/webhooks/xendit/qr'
 */
handleQrCallback.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: handleQrCallback.url(options),
    method: 'post',
})
 ...
 * @route '/api/webhooks/xendit/qr'
 */
    const handleQrCallbackForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/webhooks/xendit/qr'
 */
        handleQrCallbackForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: handleQrCallback.url(options),
            method: 'post',
        })
