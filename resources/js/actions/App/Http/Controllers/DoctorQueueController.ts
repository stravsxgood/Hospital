...
export const callPatient = (
    args:
        | { appointment: number | { appointment_id: number } }
        | [appointment: number | { appointment_id: number }]
        | number
...
callPatient.url = (
    ...
    const parsedArgs = {
        appointment:
            typeof args.appointment === 'object'
                ? args.appointment.appointment_id
                : args.appointment,
    };

    return (
        callPatient.definition.url
...
completeConsultation.url = (
    ...
    return (
        completeConsultation.definition.url
            .replace('{appointment}', parsedArgs.appointment.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/doctor/queue/{appointment}/complete'
 */
completeConsultationForm.patch = (
    args:
        | { appointment: number | { appointment_id: number } }
        | [appointment: number | { appointment_id: number }]
        | number
