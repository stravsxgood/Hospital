...
processPrescription.url = (
    ...
    return (
        processPrescription.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
completePrescription.url = (
    ...
    return (
        completePrescription.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/staff/prescriptions/{id}/complete'
 */
const completePrescriptionForm = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
