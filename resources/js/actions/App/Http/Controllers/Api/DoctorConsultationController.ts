 ...
 */
export const storeInspection = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/api/doctor/consultations/{id}/inspection'
 */
storeInspection.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
    ...
    return storeInspection.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/api/doctor/consultations/{id}/inspection'
 */
storeInspection.post = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeInspection.url(args, options),
    method: 'post',
})
 ...
 * @route '/api/doctor/consultations/{id}/inspection'
 */
    const storeInspectionForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/doctor/consultations/{id}/inspection'
 */
        storeInspectionForm.post = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: storeInspection.url(args, options),
            method: 'post',
        })
